    ...
    return (
        <div id='about' className='sm:p-16 p-4 pt-20'>
            ...
            <div className='text-slite rounded-2xl overflow-hidden bg-halfDark sm:p-7 p-5 shadow-3xl mx-3'>
                ...
                <div className='w-full flex sm:flex-row flex-col gap-5 pt-4'>
                    <div className='sm:w-1/2 w-full border border-slite rounded-xl overflow-hidden'>
                        <p className='w-full border-b border-slite p-4 text-center text-xl'>English</p>
                        <div className='flex'>
                            <a href='/resume' className="w-1/2 block border-e border-slite text-center py-3 hover:text-dark hover:bg-slite transition-all duration-300 hover:font-semibold" target='_blank'>Resume</a>
                            <a href='/letter' className="w-1/2 block  py-3 text-center hover:text-dark hover:bg-slite transition-all duration-300 hover:font-semibold" target='_blank'>Cover Letter</a>
                        </div>

                    </div>
                    <div className='sm:w-1/2 w-full border border-slite rounded-xl overflow-hidden'>
                        <p className='w-full border-b border-slite p-4 text-center text-xl'>Georgian</p>
                        <div className='flex'>
                            <a href='/resumeka' className="w-1/2 block border-e border-slite text-center py-3 hover:text-dark hover:bg-slite transition-all duration-300 hover:font-semibold" target='_blank'>Resume</a>
                            <a href='/letterka' className="w-1/2 block  py-3 text-center hover:text-dark hover:bg-slite transition-all duration-300 hover:font-semibold" target='_blank'>Cover Letter</a>
                        </div>
                ...
                <div className='flex flex-wrap justify-center'>
                    {TASKS.map((item, index) => (
                        <div key={index} className='p-3 flex xl:w-1/4 sm:w-1/2 w-full h-52'>
                            <div className='border-2 border-red rounded-2xl overflow-hidden bg-halfDark text-red flex justify-center flex-col items-center gap-4 p-7 h-full grow shadow-3xl hover:brightness-125 transition-all duration-300'>
            ...
            <div>
                ...
                <div className="flex flex-wrap justify-center items-center gap-7 text-5xl text-red pt-5">
                    <div className='bg-halfDark rounded-full p-5 overflow-hidden hover:brightness-125 transition-all duration-300'>
                        <FaHtml5 />
                    </div>
                    <div className='bg-halfDark rounded-full p-5 overflow-hidden hover:brightness-125 transition-all duration-300'>
                        <FaCss3Alt />
